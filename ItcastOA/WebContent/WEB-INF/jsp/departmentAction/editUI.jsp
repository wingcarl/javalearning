            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">上级部门</td>
                        <td><s:select name="parentId" cssClass="SelectStyle" list="departmentList" listKey="id" listValue="name" headerKey="" headerValue="===请选择部门===">
                    ...
                    <tr><td>职能说明</td>
                        <td><s:textfield name="description" cssClass="TextareaStyle"></s:textfield></td>
                    </tr>
                </table>
            </div>
        </div>
